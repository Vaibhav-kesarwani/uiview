...
const StyledWrapper = styled.div`
  ...
  .heading::before {
    ...
    box-shadow: 220px 118px #fff, 280px 176px #fff, 40px 50px #fff,
      ...
      300px 70px #fff, 150px 250px #fff, 90px 300px #fff, 450px 100px #fff;
    z-index: -1;
    transition: 1s ease;
  ...
  .icons::before {
    ...
    box-shadow: 140px 20px #fff, 425px 20px #fff, 70px 120px #fff,
      ...
      520px 50px #fff, 30px 200px #fff, 180px 20px #fff, 400px 300px #fff,
      100px 50px #fff;
    z-index: -1;
  ...
  .icons::after {
    ...
    box-shadow: 490px 330px #fff, 420px 300px #fff, 320px 280px #fff,
      ...
      120px 230px #fff, 350px -1px #fff, 150px 369px #fff, 500px 50px #fff,
      250px 100px #fff, 60px 330px #fff, 300px 120px #fff;
    z-index: -1;
    transition: 2s ease;
    animation: 1s glowing-stars linear alternate infinite;
