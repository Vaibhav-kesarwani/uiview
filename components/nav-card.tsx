  ...
  return (
    <StyledWrapper>
      <div className="card">
        ...
        <div className="heading -mt-10 ml-8 items-center text-2xl font-bold font-sans">We&apos;re on Social Media</div>
        <div className="icons">
...
const StyledWrapper = styled.div`
  ...
  .image:active + .heading::before {
    box-shadow: 240px 20px #FDF5A6, 240px 25px #FDF5A6, 240px 30px #FDF5A6, /* Changed from #9b40fc */
      240px 35px #FDF5A6, 240px 40px #FDF5A6, 242px 45px #FDF5A6,
      246px 48px #FDF5A6, 251px 49px #FDF5A6, 256px 48px #FDF5A6,
      260px 45px #FDF5A6, 262px 40px #FDF5A6;
    animation: none;
    filter: blur(0);
    border-radius: 2px;
    width: 0.45em;
  ...
  .image:active ~ .icons::before {
    box-shadow: 262px 35px #FDF5A6, 262px 30px #FDF5A6, 262px 25px #FDF5A6, /* Changed from #9b40fc */
      262px 20px #FDF5A6, 275px 20px #FDF5A6, 275px 24px #FDF5A6,
      275px 28px #FDF5A6, 275px 32px #FDF5A6, 275px 36px #FDF5A6,
      275px 40px #FDF5A6, 275px 44px #FDF5A6, 275px 48px #FDF5A6;
    animation: none;
    filter: blur(0);
    border-radius: 2px;
    width: 0.45em;
  ...
  .image:active ~ .icons::after {
    box-shadow: 238px 60px #FDF5A6, 242px 60px #FDF5A6, 246px 60px #FDF5A6, /* Changed from #9b40fc */
      250px 60px #FDF5A6, 254px 60px #FDF5A6, 258px 60px #FDF5A6,
      262px 60px #FDF5A6, 266px 60px #FDF5A6, 270px 60px #FDF5A6,
      274px 60px #FDF5A6, 278px 60px #FDF5A6, 282px 60px #FDF5A6,
      234px 60px #FDF5A6, 234px 60px #FDF5A6;
    animation: none;
    filter: blur(0);
    border-radius: 2px;
    width: 0.45em;
