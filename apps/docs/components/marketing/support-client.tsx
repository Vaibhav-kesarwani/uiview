...
const supportAccounts = [
  {
    ...
    description: "Sponsor the VectorUI maintainers.",
        ...
        <div>
          <div className={titleWrapper({class: "text-center items-center"})}>
            <div className="flex md:inline-flex flex-col md:flex-row items-center">
              <h1 className={title({size: "lg"})}>Support VectorUI&nbsp;</h1>
              <HeartBoldIcon
          ...
          >
            Using VectorUI in a profit-making product, as a software developer, or for fun projects?
            Your contributions will help to make VectorUI better.
          </p>
          {/* <Spacer y={12} /> */}
          {/* <FeaturesGrid
            classNames={{
